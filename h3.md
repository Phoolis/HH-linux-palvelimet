...
Tiivistelmä lähteestä - The Apache Software Foundation 2023: Apache HTTP Server Version 2.4 Documentation: [Name-based Virtual Host Support](https://httpd.apache.org/docs/2.4/vhosts/name-based.html):
...
Näistä ei tullut virheitä, mutta kun yrityn ottaa yhteyden Debianiin Enhanced Session Mode päällä, kirjautumisen jälkeen remote desktop sessio meni aina pimeäksi. Tämän kanssa pähkäilin jonkin aikaa, kunnes sattumalta yhdessä stackoverflow-ketjusta joku keksi mainita [kommenteissa](https://superuser.com/questions/1773172/remote-desktop-cant-connect-to-hyper-v-ubuntu-v22-04-guest#comment2763914_1773174), että pitää logata käyttäjänä ulos ensin ilman Enhanced Session modea, jotta sama käyttäjä ei sitten yritä kirjautua sisään Remote Desktopin kautta.
...
<img width="655" height="1060" alt="kuva" src="https://github.com/user-attachments/assets/3a87f9f3-66e9-4dfe-8776-0bf2252fd6c0" />


# Curl

Esimerkki `curl -I` ja perus `curl` -komennoista:

<img width="731" height="577" alt="kuva" src="https://github.com/user-attachments/assets/9f26b0a0-6727-4f7b-87c0-cd7d29091c6a" />

`curl -I` näyttää http-vastauksen headerin, ei itse webbisivua. Perus `curl` ilman lisäargumentteja palauttaa http-vastauksen suoraan, eli tässä tapauksessa html5-koodin, ei formatoitua webbisivua.
...
2. The Apache Software Foundation. Name-based Virtual Host Support. httpd.apache.org. Luettavissa: https://httpd.apache.org/. Luettu: 4.10.2025.
3. Karvinen, T. Name Based Virtual Hosts on Apache – Multiple Websites to Single IP Address. terokarvinen.com. Luettavissa: https://terokarvinen.com/2018/04/10/name-based-virtual-hosts-on-apache-multiple-websites-to-single-ip-address/. Luettu: 4.10.2025.
4. Xaqron. What is IP address '::1'?. stackoverflow.com. Luettavissa: https://stackoverflow.com/questions/4611418/what-is-ip-address-1. Luettu: 4.10.2025.
5. NAKIVO Team. Detailed Walkthrough: Install Ubuntu 20.04 on Hyper-V with Enhanced Session. nakivo.com. Luettavissa: https://www.nakivo.com/blog/install-ubuntu-20-04-on-hyper-v-with-enhanced-session/. Luettu: 4.10.2025.
6. Latif, I. Hyper-V Enhanced Session for Debian. gist.github.com. Luettavissa: https://gist.github.com/ikr4-m/67023682f949c2c22b0e51d0acb68b05. Luettu: 4.10.2025.
7. Anonymous. Kommentti ketjuun: Remote Desktop can't connect to Hyper-V Ubuntu v22.04 guest. superuser.com. Luettavissa: https://superuser.com/questions/1773172/remote-desktop-cant-connect-to-hyper-v-ubuntu-v22-04-guest#comment2763914_1773174. Luettu: 4.10.2025.
