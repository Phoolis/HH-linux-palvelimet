...
- [x] Webbisivun koodi julkiseen git-repoon GitHubiin.
...
[Repo pystyssä](https://github.com/Phoolis/paulcarlson.fi). Julkisen repon ajatuksena on se, ettei palvelimelle tarvitse antaa mitään oikeuksia GitHub-tilille, ja se myös tukee kotisivun ideaa julkisena portfoliona.
...
Kloonataan git-repo sinne: `git clone https://github.com/Phoolis/paulcarlson.fi.git`. Muokataan workflow filuun oikea polku:
...
Deploy siis tapahtyy nyt automaattisesti kun mainiin pusketaan päivityksiä. Pushin jälkeen tsekkasin, että `/home/deploy/publicsites/paulcarlson.fi/` hakemistoon oli tullut sisältöä, ja olihan sinne. Deploy successful.
...
<img width="869" height="801" alt="image" src="https://github.com/user-attachments/assets/3b9af3e4-3a5e-40f6-9b38-cc61d7536e10" />
