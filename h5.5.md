...
Olikohan tämä taas jotain AI-hallusinaatioita, vai teinkö jotain väärin? No kokeillaan toisella tapaa: `git-shell`-komentotulkilla pitäisi olla hyvin rajattu käyttö. Laitetaan se `deploy`-käyttäjän shelliksi `nologin`-shellin sijaan.
