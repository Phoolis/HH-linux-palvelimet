...
Varmaankin koska olin luonut `/home/deploy/publicsites` -kansion `sudo` komennolla, apachella ei ole oikeuksia kulkea kansioissa. Piti lisätä ne `sudo chmod o+x /home/deploy`.
