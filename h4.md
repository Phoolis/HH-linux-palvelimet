...
Menin joka tapauksessa heti eteenpäin ja lukitsin juurikäyttäjän: `sudo usermod --lock root`.
Onneksi Hetznerin ssh-ohjeissa oli vinkki miten lisätä ssh-avain uudelle käyttäjälle. Virtuaali debianista voi kopioida ssh-avaimet palvelimelle komennolla `ssh-copy-id`:
