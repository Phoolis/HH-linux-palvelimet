...
Seuraavaksi täytyy saada sanuli tarjolle myös palvelimen ulkopuolelle. Eli muuttaa `sanuli.paulcarlson.fi.conf` -filuun html-juuripolun sijaan nginx:n reverse-proxy asetukset. Reverse-proxy, eli käänteisvälityspalvelin, toimii palvelimen päässä ja ohjaa pyynnön haluttuun kohteeseen. Kinsta.com:sta löytyy hyvä intro [Reverse-proxyn käsitteeseen ja sen pystyttämiseen](https://kinsta.com/blog/reverse-proxy/). Tosin Sanulin tapauksessa nginx-palvelin on jo pystytetty docker-imagen sisään, joten ainoa conffaus mitä täytyy tehdä on Name Based Virtual Host:in conffaus.
...
Ensin asennus. Ohjelmat löytyvät debianissa dnsutils-paketista (lähde: https://superuser.com/questions/141623/installing-dig-on-debian).  `sudo apt-get install -y dnsutils`. 
...
11. Diesch, F. Installing dig on Debian. superuser.com. Luettavissa: https://superuser.com/questions/141623/installing-dig-on-debian. Luettu 24.9.2025
12. Zivanov, S. dig Command in Linux with Examples. phoenixNAP.com. Luettavissa: https://phoenixnap.com/kb/linux-dig-command-examples. Luettu 22.9.2025
