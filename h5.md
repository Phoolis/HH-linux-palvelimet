...
Seuraavaksi täytyy saada sanuli tarjolle myös palvelimen ulkopuolelle. Eli muuttaa `sanuli.paulcarlson.fi.conf` -filuun html-juuripolun sijaan nginx:n reverse-proxy asetukset seuraaviksi:
...
8. Havulinna, T. DevOps-classroom-assignments/4-dockerfile-exercise-Phoolis. GitHub.com. Luettavissa: https://github.com/DevOps-classroom-assignments/4-dockerfile-exercise-Phoolis. Luettu 22.9.2025
9. Zivanov, S. dig Command in Linux with Examples. phoenixNAP.com. Luettavissa: https://phoenixnap.com/kb/linux-dig-command-examples. Luettu 22.9.2025
