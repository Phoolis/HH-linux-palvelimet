...
Ostin domainin omalle nimelleni [paulcarlson.fi](paulcarlson.fi) suomalaisesta palvelusta [paulcarlson.fi](paulcarlson.fi):stä, koska paulcarlson.com ei ollut vapaana ja NameCheap ei tarjoa .fi -tunnuksia. Pelkkä domaini oli 16€/vuosi, ja ihmettelin aluksi kun en löytänyt mitään paikkaa missä hallinnoida siihen ohjattavaa IP-osoitetta (A-tietueet). Pienen selvittelyn jälkeen tajusin, että heillä on erillinen palvelu WebHotelli (onneksi maksuton domainin omistajalle), jonka sitten otin kylkiäiseksi. Toivottavasti sieltä pääsee muokkaamaan asetuksia.
