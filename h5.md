...
Tuostakaan ei itselle heti auennut, mistä vika voisi johtua, mutta ChatGPT-huomasi puuttuvat kenoviivan osoitteen `localhost` ja `styles-...` kohtien väliltä:

`localhost:8081styles-adca7465621429ba.css`

Olin siis unohtanut laittaa conffi-tiedostossa kenoviivat proxy-asetuksien loppuun:

    ProxyPass        "/" "http://localhost:8081/"
    ProxyPassReverse "/" "http://localhost:8081/"

Lisäsin puuttuvat kenoviivat ja a vot, sanulihan se siellä!

<img width="905" height="696" alt="kuva" src="https://github.com/user-attachments/assets/0697f584-04ae-4131-8e14-a7fe920de299" />
